...
var GAME_NAME = 'Barcelona Quiz'; // Be sure to change this for your skill.
...
exports.handler = function(event, context, callback) {
	try {
		if (event.session.application.applicationId !== "amzn1.echo-sdk-ams.app.4371677d-93b1-4192-a0c8-dd7a60e7e27b") {
...
function handleUserGuess(userGaveUp) {
    ...
    if (this.attributes['currentQuestionIndex'] == GAME_LENGTH - 1) {
        ...
        this.emit(':askWithCard', speechOutput, repromptText, GAME_NAME, correctAnswerExplanation + ".\n Next question.\n " + repromptText);
    }
}
